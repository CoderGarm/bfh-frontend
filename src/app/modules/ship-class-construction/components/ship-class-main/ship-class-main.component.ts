...
@Component({
    selector: 'app-ship-class-main',
    templateUrl: './ship-class-main.component.html',
    styleUrls: ['./ship-class-main.component.scss']
})
export class ShipClassMainComponent implements OnInit {
