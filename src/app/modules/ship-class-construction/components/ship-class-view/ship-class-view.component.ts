...
@Component({
    selector: 'app-ship-class-view',
    templateUrl: './ship-class-view.component.html',
    styleUrls: ['./ship-class-view.component.scss']
})
export class ShipClassViewComponent implements OnInit {
