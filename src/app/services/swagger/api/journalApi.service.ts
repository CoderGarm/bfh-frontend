...
export class JournalApiService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getNewlyActiveOperationals(observe?: 'body', reportProgress?: boolean): Observable<Array<Commissioning>>;
    public getNewlyActiveOperationals(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Commissioning>>>;
    public getNewlyActiveOperationals(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Commissioning>>>;
    public getNewlyActiveOperationals(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Commissioning>>('get',`${this.basePath}/api/private/journal/operationals`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
