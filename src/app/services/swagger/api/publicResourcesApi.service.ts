...
export class PublicResourcesApiService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllWormholeJunctions(observe?: 'body', reportProgress?: boolean): Observable<Junction[]>;
    public getAllWormholeJunctions(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Junction[]>>;
    public getAllWormholeJunctions(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Junction[]>>;
    public getAllWormholeJunctions(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Junction[]>('get',`${this.basePath}/api/public/resources/wormhole-junctions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
