...
import { PopulationOverview } from '../model/populationOverview';
...
export class ResourcesApiService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPopOverview(observe?: 'body', reportProgress?: boolean): Observable<PopulationOverview>;
    public getPopOverview(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PopulationOverview>>;
    public getPopOverview(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PopulationOverview>>;
    public getPopOverview(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<PopulationOverview>('get',`${this.basePath}/api/private/resources/overallPops`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
