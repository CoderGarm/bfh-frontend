...
export class BattleReportApiService {
    ...
    /**
     * Returns if there are unknown battle reports.
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public hasNewReportsForUser(observe?: 'body', reportProgress?: boolean): Observable<boolean>;
    public hasNewReportsForUser(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<boolean>>;
    public hasNewReportsForUser(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<boolean>>;
    public hasNewReportsForUser(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<boolean>('get',`${this.basePath}/api/private/report/hasNew`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
