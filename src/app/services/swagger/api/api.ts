...
export const APIS = [AuthApiService, BuildingApiService, ChatApiService, ColonizationApiService, ConstructionApiService, FleetApiService, JobApiService, ModuleApiService, PlanetApiService, ResearchApiService, ResourcesApiService, ShipyardApiService, StarMapApiService, UserApiService];
