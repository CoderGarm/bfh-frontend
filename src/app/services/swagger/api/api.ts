...
export const APIS = [AuthApiService, BuildingApiService, ChatApiService, ConstructionApiService, FleetApiService, JobApiService, PlanetApiService, ShipyardApiService, StarMapApiService, UserApiService];
