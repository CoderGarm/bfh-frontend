...
export const APIS = [AuthApiService, BuildingApiService, ChatApiService, ConstructionApiService, FleetApiService, JobApiService, PlanetApiService, ResearchApiService, ShipyardApiService, StarMapApiService, UserApiService];
