...
export * from './battle-report-api.service';
import { BattleReportApiService } from './battle-report-api.service';
...
export const APIS = [AdminApiService, AuthApiService, BuildingApiService, ChatApiService, ColonizationApiService, ConstructionApiService, FleetApiService, JobApiService, ModuleApiService, PlanetApiService, BattleReportApiService, ResearchApiService, ResourcesApiService, ShipyardApiService, StarMapApiService, TickApiService, UserApiService];
